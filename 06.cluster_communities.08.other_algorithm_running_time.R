...
# for (cancer_type in cancer_types) {
    ...
    output_file <- "other_algorithms_running_time.txt"
    output_path <- file.path(output_dir, output_file)
    cat("louvain_algorithm", result_time["elapsed"], file = output_path, sep = ",", "\n", append = T)
    ...
    output_file <- "other_algorithms_running_time.txt"
    output_path <- file.path(output_dir, output_file)
    cat("fast_greedy", result_time["elapsed"], file = output_path, sep = ",", "\n", append = T)
    ...
    output_file <- "other_algorithms_running_time.txt"
    output_path <- file.path(output_dir, output_file)
    cat("walkstrap", result_time["elapsed"], file = output_path, sep = ",", "\n", append = T)
    ...
    output_file <- "other_algorithms_running_time.txt"
    output_path <- file.path(output_dir, output_file)
    cat("leading_eigen", result_time["elapsed"], file = output_path, sep = ",", "\n", append = T)
    ...
    output_file <- "other_algorithms_running_time.txt"
    output_path <- file.path(output_dir, output_file)
    cat("label-propagation", result_time["elapsed"], file = output_path, sep = ",", "\n", append = T)
    ...
    output_file <- "other_algorithms_running_time.txt"
    output_path <- file.path(output_dir, output_file)
    cat("edge_betweenness", result_time["elapsed"], file = output_path, sep = ",", "\n", append = T)
